...
<?
    ...
    $sql = "select * from member where id='$userid'"; //'green'
     ...
     <table>
      <caption class="hidden">회원가입</caption>
     	...
     	<tr>
     		...
     		<td>
     			<input type="text" name="name" id="name" value="<?= $row[name] ?>"  required placeholder="이름"> 
     		</td>
     	</tr>
     	<tr>
     		<th scope="col"><label for="nick">닉네임</label></th>
     		<td>
     			 <input type="text" name="nick" id="nick" value="<?= $row[nick] ?>"  required placeholder="닉네임">
     	...
     	<tr>
     		...
     		<td>
     		  <label class="hidden" for="email1">이메일아이디</label>
     			<input type="text" id="email1" name="email1" value="<?= $email1 ?>" required placeholder="이메일주소"> @ 
